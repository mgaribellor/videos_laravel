...
<head>
    ...
    <title>{{ config('app.name', 'LaravDel') }}</title>
...
<body style="background-color: rgba(129, 217, 176, 0.25);">
    <div id="app">
        <nav class="navbar navbar-default navbar-static-top" style="background-color: #1c0d0d">
            <div class="container">
